...
export class ListaAlunoComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private _serviceAluno: AlunoService, private _snackBar: MatSnackBar) {}
  ngOnInit(): void {
  ...
  abreFormularioAluno(aluno: Aluno | any) {
    ...
    dialogRef.afterClosed().subscribe((result: Aluno) => this.processaRegistro(result))
  }
  ...
  excluiRegistroAluno(aluno: Aluno) {
